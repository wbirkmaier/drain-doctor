...
The current slice analyzes a node, nodegroup, or availability zone from offline fixtures and reports blockers, warnings, PodDisruptionBudget exhaustion, replica shortfall risk, conservative rescheduling risk, ordered eviction guidance, and advisory patch suggestions.
